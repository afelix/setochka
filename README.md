...
Основным сценарием использования видится выделение вендорных свойств по шаблонам&nbsp;— то, ради чего создана Сеточка, и под эту задачу созданы настройки по умолчанию, которые можно посмотреть [здесь](https://github.com/afelix/setochka/blob/master/lib/config.js).
